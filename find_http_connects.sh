...
TZ=UTC tshark -r $pcap -Y "http.request.method == CONNECT" -T fields -e frame.time -e ip.src -e tcp.srcport -e ip.dst -e tcp.dstport -e tcp.stream -e http.request.uri -e http.request.line
